    ...
    <section className="py-14 relative">
      ...
      <div className="max-lg:content-boundary grid grid-cols-1 lg:bleed-grid-1440 gap-y-18">
        {collabFeats.map((content) => (
          <section key={content.title} className="group col-start-2">
            <figure className="grid grid-cols-1 lg:grid-cols-[10fr_.5fr_14fr] lg:group-nth-of-type-2:grid-cols-[13fr_12fr] gap-y-8">
