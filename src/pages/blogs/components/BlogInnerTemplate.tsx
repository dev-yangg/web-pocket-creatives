        ...
        <article>
          ...
          {blog.content && blog.content.length > 0 ? (
            ...
            <EmptyStateHandler
              ...
              className="text-heading-4 pt-8 pb-18"
            />
          )}

          {/* Like button */}
          {blog.content && blog.content.length > 0 && (
            <div className="flex flex-col xs:flex-row xs:items-center gap-x-4 gap-y-8">
              <LikeButton likeCount={blog.likeCount} />
              <div className="h-full w-full grow relative after:absolute after:inset-x-0 after:top-1/2 after:-translate-y-1/2 after:bg-grayblue after:h-0.5"></div>
            </div>
          )}
        </article>
